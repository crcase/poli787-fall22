---
title: "POLI 787 - Covariate Balancing and CBPS"
author: "Colin Case"
date: "October 6, 2022"
...
ps.mod <- glm(______ ~ age + educ + married + nodegree + re74 + re75, 
...
W.out <- ________(______ ~ age + educ + married + nodegree + re74 + re75,
...
```{r}
CPBS.out <-  ______(_____ ~ age + educ + married + nodegree + re75 + re74, 
...
bal.tab(treat~ _____ + _____ + ____ + _____, 
...
tmod1 <- __________________________
...
W.out <- weightit(_______________________,
                  s.weights="weights")
# Check balance
