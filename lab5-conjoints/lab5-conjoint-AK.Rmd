...
For today's exercise, I want you to create a Qualtrics survey on your own to work with editing the javascript code. For your design, you are more than welcome to use the table setup and add or delete variables. But your design must incldue the following:

1. At least three randomly assigned variables with no dependencies

2. One variable where it should be different for each candidate.

3. One variable with pre-specified weights to match some sort of population value.

For the lab, please submit the Qualtrics survey preview link.
