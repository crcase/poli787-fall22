...
xyplot(as.numeric(______) ~ as.numeric(______) | _______, # Random Slope Model
       data=________, main="Left-Right Scale by Country",
...
ggplot(dat2, aes (x = _______, y = _____, colour = ______, group = ______)) + 
  geom_point(position = "jitter", alpha = .05) +
  geom_smooth(method = "lm", se = F) +
