...
m1 <- lm(________________________________)
summary(m1)
```
...
m2 <- lm(____________________________)
summary(m2)
```
...
m3 <- lm(__________________________________________________) 
summary(m3)
```
...
m4 <- mediate(___, ____, _____, _____, _______);
summary(m4)
```
...
___$coefficients['______']*___$coefficients['_____']
# ADE (Effect of treatment on outcome while controlling for mediator)
___$coefficients['_____']
# Total Effect (Effect of treatment on outcome without mediator)
___$coefficients['______']
# Prop. Mediated (ACME/Total Effect)
___$coefficients['______']*___$coefficients['____']/___$coefficients['______']
```
...
med_res30 <- mediate(___, ___, _____, _______,______,
...
med_res60 <- mediate(___, ___, _____, _______,______,
...
sens.indirect <- ________(___, sims= 300, effect.type= "_______") 
summary(sens.indirect)
plot(sens.indirect)

# Sensitivity analysis for direct effects
sens.direct <- _____(__, sims= 300, effect.type= "_______") 
summary(sens.direct)
plot(sens.direct)
