...
dbar <- ______ # Mean difference between treatment and control for distance
m <- (______)/2 # Number in treatment
n <- (______)/2 # Number in control
N <- m+n # Total Sample Size
x.var <-  (______)^2 # Calculate variance from pooled standard deviation (treatment)
y.var <- (____)^2 # Calculate variance from pooled standard deviation (control)
...
treatment <- _________________ # Create treatment DF
control <- ___________________ # Create control DF

for(_______){ # Create loop for all pre-treatment covariates
  temp <- ________________________ # t.test for each covariate
...
e.test <- ____________________, # Specify covariate ~ treatment status
       _____________, # Call data
       _________, # Alpha level equal to 0.05
       ____________________________, # Set LB and UB (raw number)
